...
<td>" . $res['phoneno'] . "</td>
<td><button class='btn edit btn-primary btn-sm mr-2' id='space'" . $res['sno'] . ">Approved</button><button class='btn delete btn-primary btn-sm mr-3' id=d" . $res['sno'] . ">Disaproved</button> </td>
</tr>";
        }
        ?>
      </tbody>
