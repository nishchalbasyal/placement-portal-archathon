...
<div class="container mt-sm-5 my-1">
    ...
    <div class="questions">  
                ...
                <p>4.Maecenas quis tellus ut ante porttitor convallis. Duis a justo tortor. Proin consequat volutpat gravida. Vestibulum </p>
                 <input type="radio" name="q4" value="13"> A. vehicula  <br>
                 <input type="radio" name="q4" value="14"> B. Duis  <br>
                 <input type="radio" name="q4" value="15"> C. mi <br>
                 <input type="radio" name="q4" value="16"> D. faucibus <br><br>
                <hr>
                </div>
